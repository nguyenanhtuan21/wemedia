...
T.plan_path = ".cline/tasks/"

T.backlog_path = ".cline/tasks/backlog.md"

T.sprint_path = ".cline/tasks/sprint_{n}/"
...
TDD.spec_path = ".cline/tasks/sprint_{n}/spec_step_{x}.md"
...
Ξ.error_memory = ".cline/memory/errors.md"
...
Ψ.output_path = ".cline/memory/trace_{task_id}.md"
